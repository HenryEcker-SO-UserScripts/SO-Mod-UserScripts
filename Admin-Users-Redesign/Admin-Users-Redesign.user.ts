...
(function () {
    ...
    function rebuildPage(currentTab: string, currentPage: string, displayName: string): JQuery {
    ...
    function buildNavLi(tabText: string, tabTitle: string, queryLocation: string, currentTab: string, mainOnly: boolean | undefined): JQuery | null {
    ...
    function buildMainBody(currentTab: string, currentPage: string, displayName: string): JQuery {
    ...
    function attachLoadListenerToDiv(node: HTMLElement, currentTab: string, displayName: string) {
    ...
    function updateURLSearchParamPage(newPage: string | null | undefined) {
    ...
    function highlightOwnItems(displayName: string) {
    ...
    function fetchInformationFromPage(): {
        ...
        return {
            ...
            displayName: $('.s-topbar--item.s-user-card .s-avatar').first().attr('title') as string
        };
    }
